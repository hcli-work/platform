...
class Keypair < ApplicationRecord
  ALGORITHM = 'RS256'
  # TODO: I was getting an error about the encryption_key needing to be 32 bytes. Following this post, but the pack() call is weird: https://ankane.org/encryption-keys
  attr_encrypted :_keypair, key: [Rails.application.secrets.encryption_key].pack("H*")
